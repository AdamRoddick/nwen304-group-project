...
export type RequestMethod = "GET" | "HEAD" | "PATCH" | "PUT" | "POST" | "DELETE" | "CONNECT" | "OPTIONS" | "TRACE" | "PATCH";
...
export type CsrfCookieSetter = (res: Response, name: string, value: string, options: DoubleCsrfCookieOptions) => void;
...
export declare function doubleCsrf({ getSecret, cookieName, cookieOptions: { sameSite, path, secure, ...remainingCOokieOptions }, size, ignoredMethods, getTokenFromRequest, }: DoubleCsrfConfigOptions): DoubleCsrfUtilities;
